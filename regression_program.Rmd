...
library(lattice)
library(rstanarm)
source('~/Downloads/r_programs/regression/mixed_models/resid_anal_nlme.R')
source('~/Downloads/r_programs/regression/cook_hat.R')
source('~/Downloads/r_programs/regression/norm_diag.R')
source('~/Downloads/r_programs/regression/envel_norm.R')
source('~/Downloads/r_programs/regression/statistics_model_comparison.R')
```
...
# FIT THE MODEL
matrixFit <- stan(file = "~/Downloads/undergraduate/1sem20/ME714/application/matrixModel.stan",
                  data=stanDat,
                  iter = 2000, chains = 4)
```
